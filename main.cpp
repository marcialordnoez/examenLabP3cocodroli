...
SDL_Event Event;
SDL_Texture *background,*character, *bullet, *enemy,*enemy1;
SDL_Rect rect_background,rect_character, rect_bullet, rect_enemy,rect_enemy1;
...
int main( int argc, char* args[] )
{
    ...
    enemy1 = IMG_LoadTexture(renderer, "enemy1.png");
    SDL_QueryTexture(enemy, NULL, NULL, &w, &h);
    rect_enemy1.x = 0;
    rect_enemy1.y = 100;
    rect_enemy1.w = w;
    ...
    //esto se usa para que se mueva con los cursores
        ...
        for(list<Enemy*>::iterator i=enemies.begin(); i!=enemies.end();)
        {
            Enemy* temp = *i;
            rect_enemy.x = temp->x;
            rect_enemy.y = temp->y;
            ...
            i++)
        {
                ...
                j++)
            {
                ...
                rect_bullet.y = current_bullet->y;
                 ...
                 rect_enemy1.x = current_enemy1->x;
                rect_enemy1.y = current_enemy1->y;
                ...
                if(collisionCheck(rect_enemy1,rect_bullet))
                {
                    list<Bullet*>::iterator to_erase=j;
                    j--;
                    bullets.erase(to_erase);
